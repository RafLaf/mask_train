...
_C.DATA.TEST.EPISODE_DESCR_CONFIG.REPLACEMENT = False
...
_C.MODEL.RESUME = ''
_C.MODEL.EPOCH_HEAD = 10
_C.MODEL.EPOCH_LORA = 20
_C.MODEL.LR_HEAD = 0.1
_C.MODEL.LR_LORA = 0.00001
_C.MODEL.OPTIMIZER_HEAD = 'adam'
_C.MODEL.OPTIMIZER_LORA = 'adam'
_C.MODEL.REGULARIZATION_HEAD= 1.0
_C.MODEL.REGULARIZATION_LORA = 0.0
_C.MODEL.LR_MASK = 0.1
_C.MODEL.REG_MASK = 0.0
_C.MODEL.EPOCH_MASK = 10
_C.MODEL.BINARY_MASK = False
_C.MODEL.N_LOWEST = 1
