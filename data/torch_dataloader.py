...
class TorchDataset(Dataset):
    ...
    def set_epoch(self) -> None:
        ...
        for _ in range(self.iteration_per_epoch):
            ...
            #index=0
            if self.is_episodic:
                all_images, all_labels = self.samplers[index].sample_multiple_episode(self.batch_size, self.episode_descr_config.SEQUENTIAL_SAMPLING, self.episode_descr_config.REPLACEMENT)
