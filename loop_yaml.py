...
name_of_experiment = "15queries"
S = Data["DATA"]["TEST"]["EPISODE_DESCR_CONFIG"]["NUM_SUPPORT"]
Data["SEED"]=0

os.makedirs('./configs/{}/{}-shot'.format(name_of_experiment,S,model),exist_ok=True)
os.makedirs('./configs/{}/{}-shot/{}'.format(name_of_experiment,S,model),exist_ok=True)
...
for method in list_methods:
   ...
   for i in range(1,10):
      ...
      if not os.path.exists('./configs/{}/{}-shot/{}/{}'.format(name_of_experiment,S,model,method)):
         os.makedirs('./configs/{}/{}-shot/{}/{}'.format(name_of_experiment,S,model,method))
      with open('./configs/{}/{}-shot/{}/{}/{}.yaml'.format(name_of_experiment,S,model,method,dataset), 'w') as f:
